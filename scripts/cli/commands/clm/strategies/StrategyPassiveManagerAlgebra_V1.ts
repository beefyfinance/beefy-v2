...
export default {
  tokenProviderId: async (chainId, strategyAddress, vaultReceiptName) => {
    ...
    if (name.platform.toLowerCase() === 'stella') {
      return 'stellaswap';
    }
  ...
  abi: [
    ...
    { inputs: [], name: 'TooMuchSlippage', type: 'error' },
    {
      anonymous: false,
      inputs: [
        { indexed: false, internalType: 'uint256', name: 'callFeeAmount', type: 'uint256' },
        { indexed: false, internalType: 'uint256', name: 'beefyFeeAmount', type: 'uint256' },
        { indexed: false, internalType: 'uint256', name: 'strategistFeeAmount', type: 'uint256' },
      ],
      name: 'ChargedFees',
      type: 'event',
    },
    {
      ...
      inputs: [
        ...
        { indexed: false, internalType: 'uint256', name: 'feeMain1', type: 'uint256' },
        { indexed: false, internalType: 'uint256', name: 'feeAlt0', type: 'uint256' },
        { indexed: false, internalType: 'uint256', name: 'feeAlt1', type: 'uint256' },
      ],
      name: 'ClaimedFees',
      type: 'event',
    },
    ...
    },
    {
      ...
      inputs: [
        ...
        { indexed: false, internalType: 'int24', name: 'width', type: 'int24' },
      ],
    ...
    },
    {
      anonymous: false,
      inputs: [
        { indexed: false, internalType: 'uint32', name: 'oldInterval', type: 'uint32' },
    ...
    },
    {
      ...
      inputs: [
        ...
        { indexed: false, internalType: 'uint256', name: 'bal1', type: 'uint256' },
      ],
      name: 'TVL',
      type: 'event',
    },
    ...
    },
    {
      ...
      outputs: [
        ...
        { internalType: 'uint256', name: 'token1Bal', type: 'uint256' },
      ],
    ...
    },
    {
      ...
      outputs: [
        ...
        { internalType: 'uint256', name: 'mainAmount1', type: 'uint256' },
        { internalType: 'uint256', name: 'altAmount0', type: 'uint256' },
        { internalType: 'uint256', name: 'altAmount1', type: 'uint256' },
      ],
      stateMutability: 'view',
      type: 'function',
    },
    ...
    },
    {
      ...
      outputs: [
        ...
        { internalType: 'bytes32', name: 'keyAlt', type: 'bytes32' },
      ],
      stateMutability: 'view',
      type: 'function',
    },
    ...
    },
    {
      ...
      outputs: [
        ...
        { internalType: 'uint256', name: 'locked1', type: 'uint256' },
      ],
      stateMutability: 'view',
      type: 'function',
    },
    ...
    { inputs: [], name: 'moveTicks', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    {
      inputs: [],
      name: 'native',
      outputs: [{ internalType: 'address', name: '', type: 'address' }],
