...
import type { FCWithRef, HtmlProps, Override } from '../../../features/data/utils/types-utils';
...
export type CommonProps<TItem extends SelectItem = SelectItem> = Override<ButtonVariantProps, {
    className?: string;
    labelPrefix?: string;
...
export type SelectSingleProps<TItem extends SelectItem = SelectItem> = CommonProps<TItem> & SingleOnlyProps<TItem>;
export type SelectMultiProps<TItem extends SelectItem = SelectItem> = CommonProps<TItem> & MultiOnlyProps<TItem>;
...
export type OptionButtonProps = Override<ButtonProps, {
    active: boolean;
    selected: boolean;
}>;
export type OptionLabelProps = Override<SpanProps, {
    selected: boolean;
}>;
...
export type OptionBadgeProps = Override<SpanProps, {
    selected: boolean;
}>;
export type OptionEndAdornmentProps = Override<DivProps, {
    selected: boolean;
}>;
export type CommonSelectedButtonProps = Override<Override<ButtonProps, ButtonVariantProps>, {
    selected: boolean;
}>;
export type CommonSelectedLabelProps = Override<SpanProps, {
    selected: boolean;
}>;
export type CommonSelectedLabelPrefixProps = Override<SpanProps, {
    selected: boolean;
}>;
export type CommonSelectArrowProps = Override<SvgProps, {
    active?: boolean;
}>;
type CommonSelectedProps = Override<ButtonVariantProps, {
    labelPrefix?: string;
    unselectedLabel: string;
    active: boolean;
...
export type SearchFunction<TItem extends SelectItem = SelectItem> = (item: TItem, search: string) => boolean;
