...
import type { SvgProps } from '../../../../features/data/utils/types-utils';
...
export declare function isNavItemConfig(config: NavConfig): config is NavItemConfig;
export declare function isNavDropdownConfig(config: NavConfig): config is NavDropdownConfig;
export {};
