...
export declare function isUserStandardPnl(pnl: UserVaultPnl): pnl is UserStandardPnl;
export declare function isUserGovPnl(pnl: UserVaultPnl): pnl is UserGovPnl;
export declare function isUserClmPnl(pnl: UserVaultPnl): pnl is UserClmPnl;
