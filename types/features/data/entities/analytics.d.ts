...
export type UnprocessedTimelineEntryStandard = Prettify<Rest<Record<'shareBalance' | 'shareDiff' | 'shareToUnderlyingPrice' | 'underlyingBalance' | 'underlyingDiff', BigNumber> & Record<'underlyingToUsdPrice' | 'usdBalance' | 'usdDiff', BigNumber | null> & Record<'datetime', Date>, TimelineConfigDatabarnSnake> & {
    type: 'standard';
...
export type UnprocessedTimelineEntryCowcentratedWithoutRewardPool = UnprocessedTimelineEntryCowcentratedBasePart & UnprocessedTimelineEntryCowcentratedWithoutRewardPoolPart;
export type UnprocessedTimelineEntryCowcentratedWithRewardPools = UnprocessedTimelineEntryCowcentratedBasePart & UnprocessedTimelineEntryCowcentratedWithRewardPoolsPart;
export type UnprocessedTimelineEntryCowcentratedPool = UnprocessedTimelineEntryCowcentratedWithoutRewardPool | UnprocessedTimelineEntryCowcentratedWithRewardPools;
...
export type UnprocessedTimelineEntryCowcentratedVaultWithoutRewardPool = UnprocessedTimelineEntryCowcentratedVaultBasePart & UnprocessedTimelineEntryCowcentratedVaultWithoutRewardPoolPart;
export type UnprocessedTimelineEntryCowcentratedVaultWithRewardPools = UnprocessedTimelineEntryCowcentratedVaultBasePart & UnprocessedTimelineEntryCowcentratedVaultWithRewardPoolsPart;
export type UnprocessedTimelineEntryClassicVault = UnprocessedTimelineEntryCowcentratedVaultWithoutRewardPool | UnprocessedTimelineEntryCowcentratedVaultWithRewardPools;
...
export type AnyTimelineEntry = TimelineEntryStandard | TimelineEntryCowcentratedPool | TimelineEntryCowcentratedVault;
...
export type AnyTimelineEntity = TimelineEntityStandard | TimelineEntityCowcentratedPool | TimelineEntityCowcentratedVault;
export declare function isTimelineEntryStandard(entry: AnyTimelineEntry): entry is TimelineEntryStandard;
export declare function isTimelineEntryCowcentratedPool(entry: AnyTimelineEntry): entry is TimelineEntryCowcentratedPool;
export declare function isTimelineEntryCowcentratedVault(entry: AnyTimelineEntry): entry is TimelineEntryCowcentratedVault;
export declare function isTimelineEntityStandard(entity: AnyTimelineEntity | undefined): entity is TimelineEntityStandard;
export declare function isTimelineEntityCowcentratedPool(entity: AnyTimelineEntity | undefined): entity is TimelineEntityCowcentratedPool;
export declare function isTimelineEntityCowcentratedVault(entity: AnyTimelineEntity | undefined): entity is TimelineEntityCowcentratedVault;
export declare function isTimelineEntityCowcentrated(entity: AnyTimelineEntity | undefined): entity is TimelineEntityCowcentratedPool | TimelineEntityCowcentratedVault;
export {};
