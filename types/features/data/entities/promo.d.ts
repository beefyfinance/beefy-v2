...
import type { AirdropPromoConfig, BoostPromoConfig, OffChainPromoConfig, PoolPromoConfig, PromoCampaignConfig, PromoPartnerConfig, PromoTokenRewardConfig } from '../apis/promos/types';
import type { ChainEntity } from './chain';
export type PromoTokenReward = Override<PromoTokenRewardConfig, {
...
export type BoostPromoEntity = Override<BoostPromoConfig, BasePromoOverrides & {
    version: number;
}>;
...
export type PromoEntity = BoostPromoEntity | OffChainPromoEntity | PoolPromoEntity | AirdropPromoEntity;
export type PromoPartnerEntity = PromoPartnerConfig & {
    id: string;
};
