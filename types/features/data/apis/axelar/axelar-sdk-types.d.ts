...
export type AxelarChain = 'ethereum' | 'avalanche' | 'fantom' | 'polygon' | 'polygon-zkevm' | 'moonbeam' | 'aurora' | 'binance' | 'arbitrum' | 'celo' | 'kava' | 'base' | 'filecoin' | 'optimism' | 'linea' | 'mantle' | 'scroll' | 'fraxtal' | 'blast';
/** @see https://github.com/axelarnetwork/axelarjs-sdk/blob/main/src/constants/GasToken.ts */
export type AxelarGasToken = 'AVAX' | 'GLMR' | 'MATIC' | 'ETH' | 'FTM' | 'aETH' | 'BNB' | 'CELO' | 'KAVA' | 'FIL' | 'MNT' | 'frxETH';
...
type AxelarResponse<TRequest extends {
    method: string;
}, TResult> = {
...
export interface IAxelarSDK {
    ...
    estimateGasFee(sourceChainId: AxelarChain, sourceContractAddress: string, sourceChainTokenSymbol: AxelarGasToken, destinationChainId: AxelarChain, destinationContractAddress: string, gasLimit: BigNumber, executeData: string, gasMultiplier: number | 'auto', 
    /** in wei */
