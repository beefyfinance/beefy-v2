...
export type TimelineActionClm = 'MANAGER_DEPOSIT' | 'MANAGER_WITHDRAW' | 'CLM_REWARD_POOL_STAKE' | 'CLM_REWARD_POOL_UNSTAKE' | 'CLM_REWARD_POOL_CLAIM';
export type TimelineActionClassic = 'VAULT_DEPOSIT' | 'VAULT_WITHDRAW' | 'CLASSIC_REWARD_POOL_STAKE' | 'CLASSIC_REWARD_POOL_UNSTAKE' | 'CLASSIC_REWARD_POOL_CLAIM';
