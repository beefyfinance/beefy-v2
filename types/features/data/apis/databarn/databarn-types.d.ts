...
export type DatabarnPriceType = 'share_to_underlying' | 'underlying_to_usd' | 'pending_rewards_to_usd';
export type DatabarnTimeBucket = '1h_1d' | '1h_1w' | '1h_1M' | '1d_1M' | '1d_1Y' | '1d_all';
...
export interface IDatabarnApi {
    ...
    getVaultPrices(productType: 'vault' | 'boost', priceType: DatabarnPriceType, timeBucket: DatabarnTimeBucket, address: string, chain: string): Promise<DatabarnPricesResponse>;
}
