...
import { type VaultCowcentrated, type VaultErc4626, type VaultGov, type VaultGovMulti, type VaultStandard } from '../../entities/vault';
import type { BeefyState } from '../../store/types';
export interface IContractDataApi {
    fetchAllContractData(state: BeefyState, entities: FetchAllContractDataEntities): Promise<FetchAllContractDataResult>;
}
