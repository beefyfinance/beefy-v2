...
export type SwapRequest = Pick<QuoteRequest, 'src' | 'dst' | 'amount' | 'protocols' | 'fee' | 'gasPrice' | 'complexityLevel' | 'parts' | 'mainRouteParts' | 'gasLimit' | 'includeTokensInfo' | 'includeProtocols' | 'includeGas' | 'connectorTokens' | 'excludedProtocols'> & {
