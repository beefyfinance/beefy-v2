...
import type { AllowanceTokenAmount, InputTokenAmount, TokenAmount, ZapDepositQuote, ZapQuoteStep, ZapQuoteStepSwapAggregator } from '../transact-types';
import type { OrderInput, OrderOutput, ZapStep } from '../zap/types';
import type { ChainTransactHelpers, ZapTransactHelpers } from '../strategies/IStrategy';
...
export declare function isVaultDestState(state: DestState): state is VaultDestState;
...
export interface ISourceHandler<Q = unknown> {
    ...
    fetchZapSteps(quote: SourceHandlerQuote<Q>, ctx: SourceHandlerContext): Promise<SourceHandlerSteps>;
}
