...
import type { DepositOption, DepositQuote, InputTokenAmount, TransactQuote, WithdrawOption, WithdrawQuote, ZapStrategyIdToDepositOption, ZapStrategyIdToDepositQuote, ZapStrategyIdToWithdrawOption, ZapStrategyIdToWithdrawQuote } from '../transact-types';
...
export interface IComposableStrategy<TId extends ZapStrategyId = ZapStrategyId> extends IZapStrategy<TId> {
...
export interface IComposerStrategyStatic<TId extends ZapStrategyId = ZapStrategyId> {
    ...
    new (options: StrategyIdToConfig<TId>, helpers: ZapTransactHelpers, underlyings: AnyComposableStrategy[]): IComposerStrategy<TId>;
}
export type IAnyStrategyStatic<TId extends ZapStrategyId = ZapStrategyId> = IZapStrategyStatic<TId> | IComposableStrategyStatic<TId> | IComposerStrategyStatic<TId>;
...
export declare function isZapTransactHelpers(helpers: TransactHelpers): helpers is ZapTransactHelpers;
export declare function isComposableStrategy(strategy: IStrategy): strategy is IComposableStrategy;
export {};
