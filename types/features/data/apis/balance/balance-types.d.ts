...
import type { VaultEntity, VaultErc4626, VaultGov } from '../../entities/vault';
import type { BeefyState } from '../../store/types';
export interface IBalanceApi {
    fetchAllBalances(state: BeefyState, entities: FetchAllBalancesEntities, walletAddress: string): Promise<FetchAllBalancesResult>;
}
