...
import type { GasPricing } from '../gas-prices/gas-prices';
...
export type UpdatePayload<TId extends string = string, TData extends BaseUserData = BaseUserData> = UpdateResult<TId, TData> & {
    vault: VaultEntity;
    walletAddress: Address;
};
export type ExecuteParams<TId extends string = string, TData extends BaseUserData = BaseUserData> = {
    migrationId: TId;
    vault: VaultEntity;
    walletAddress: Address;
...
export type UpdateFn<TId extends string = string, TData extends BaseUserData = BaseUserData> = (params: UpdateParams<TId>) => Promise<UpdateResult<TId, TData>>;
export type ExecuteFn<TId extends string = string, TData extends BaseUserData = BaseUserData> = (params: ExecuteParams<TId, TData>) => Promise<ExecuteResult<TId>>;
