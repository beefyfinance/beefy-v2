...
import type { KeysOfUnion, MergeObjectUnion } from '../../utils/types-utils';
...
export type BeefyOffChainRewardsBeefyCampaignType = 'test' | 'arb-ltipp' | 'op-gov-fund' | 'zap-v3' | 'mode-grant' | 'other';
export type BeefyOffChainRewardsExternalCampaignType = 'external';
export type BeefyOffChainRewardsCampaignType = BeefyOffChainRewardsBeefyCampaignType | BeefyOffChainRewardsExternalCampaignType;
type MakeCampaign<TProvider extends BeefyOffChainRewardsProviderId, TExtra extends Record<string, unknown>> = {
...
export type BeefyOffChainRewardsMerklCampaign = MakeCampaign<'merkl', {
    campaignId: string;
}>;
export type BeefyOffChainRewardsStellaSwapCampaign = MakeCampaign<'stellaswap', {
    rewardId: number;
    rewarderAddress: string;
    isPaused: boolean;
}>;
export type BeefyOffChainRewardsCampaign = BeefyOffChainRewardsMerklCampaign | BeefyOffChainRewardsStellaSwapCampaign;
export {};
