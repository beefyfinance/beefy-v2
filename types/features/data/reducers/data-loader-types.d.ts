...
export type LoaderState = LoaderStateIdle | LoaderStatePending | LoaderStateRejected | LoaderStateFulfilled;
...
export type LoaderNotificationKey = LoaderNotificationCategory | `${LoaderNotificationCategory}-${ChainId}`;
