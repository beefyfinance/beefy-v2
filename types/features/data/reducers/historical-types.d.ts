...
type TimeBucketByVaultIdState<T extends AnyChartData = AnyChartData> = HistoricalByVaultIdState<TimeBucketsState<T>>;
type TimeBucketByOracleIdState<T extends AnyChartData = AnyChartData> = HistoricalByOracleIdState<TimeBucketsState<T>>;
...
export type HistoricalTimeBucketStateKeys = HistoricalTimeBucketByOracleIdStateKeys | HistoricalTimeBucketByVaultIdStateKeys;
export {};
