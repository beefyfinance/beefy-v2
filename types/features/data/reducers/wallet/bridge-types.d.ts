...
import type { BeefyAnyBridgeConfig, BeefyBridgeConfig, BeefyBridgeIdToConfig } from '../../apis/config-types';
...
export type BridgeQuoteState = {
    ...
    quotes: {
        ...
        byId: Partial<Record<IBridgeQuote<BeefyAnyBridgeConfig>['id'], IBridgeQuote<BeefyAnyBridgeConfig>>>;
    };
    limitedQuotes: {
        allIds: IBridgeQuote<BeefyAnyBridgeConfig>['id'][];
        byId: Partial<Record<IBridgeQuote<BeefyAnyBridgeConfig>['id'], IBridgeQuote<BeefyAnyBridgeConfig>>>;
...
export type BridgeState = {
    ...
    destinations: {
        ...
        chainToBridges: Partial<Record<ChainEntity['id'], Record<ChainEntity['id'], BeefyAnyBridgeConfig['id'][]>>>;
    };
