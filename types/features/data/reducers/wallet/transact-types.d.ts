import type { OptionFeeCampaign, QuoteOutputTokenAmountChange, RecoveryQuote, TokenAmount, TransactOption, TransactQuote, ZapQuoteStep } from '../../apis/transact/transact-types';
import type { VaultEntity } from '../../entities/vault';
import type { TokenEntity } from '../../entities/token';
import type { ChainEntity } from '../../entities/chain';
import type BigNumber from 'bignumber.js';
import type { SerializedError } from '../../apis/transact/strategies/error-types';
export declare enum TransactStep {
    Loading = 0,
    Form = 1,
    ChainSelect = 2,
    TokenSelect = 3,
    QuoteSelect = 4,
    DepositFromVaultSelect = 5
}
export declare enum TransactMode {
    Deposit = 0,
    Withdraw = 1,
    Claim = 2,
    Boost = 3,
...
export declare enum DepositSource {
    Wallet = "wallet",
    Vault = "vault"
}
export declare enum TransactStatus {
    Idle = 0,
    Pending = 1,
    Rejected = 2,
    Fulfilled = 3
...
export type CrossChainOpStatus = 'source-pending' | 'source-done' | 'source-failed' | 'dest-pending' | 'dest-done' | 'dest-failed' | 'dest-recovered';
...
export type CrossChainRecoveryParams = CrossChainRecoveryPassthrough | CrossChainRecoverySwap | CrossChainRecoveryVault;
