var __dsPreview = (() => {
  ...
  // .design-sync/previews/SummaryStats.tsx
  var SummaryStats_exports = {};
  __export(SummaryStats_exports, {
    Platform: () => Platform,
    Portfolio: () => Portfolio
  });
  init_define_import_meta_env();
  ...
  var Portfolio = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.SummaryStats,
    {
      items: [
  ...
  var Platform = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.SummaryStats,
    {
      items: [
  ...
  return __toCommonJS(SummaryStats_exports);
})();
