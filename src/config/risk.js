...
export const RISKS = {
  COMPLEXITY_LOW: {
    ...
    condition: "A low complexity strategy should interact with just one audited and well-known smart contract e.g. MasterChef. The strategy serves as a façade for this smart contract, forwarding deposit, harvest and withdrawal calls using a single line of code." 
  },
  ...
  IL_NONE: {
    ...
    condition: "Single asset vaults and vaults that manage stablecoins with a peg that isn’t experimental: USDT, USDC, DAI, sUSD, etc." 
  },
  ...
  IL_LOW: {
    ...
    condition: "Vaults that handle what are normally referred as “Pool 1” LPs would fit here: ETH-USDC, MATIC-AAVE, etc. Governance tokens for smaller projects are normally known as “Pool 2” and thereby excluded." 
  },
  ...
  IL_HIGH: {
    ...
    condition: "Vaults that handle “Pool 2” LPs go here. These LP normally include the governance token of the farm itself." 
  },
