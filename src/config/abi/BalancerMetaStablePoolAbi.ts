...
export const BalancerMetaStablePoolAbi = [
  {
    inputs: [
      {
        components: [
          ...
          { internalType: 'uint256[]', name: 'priceRateCacheDuration', type: 'uint256[]' },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'lastInvariant', type: 'uint256' },
      { internalType: 'uint256', name: 'lastInvariantAmp', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [{ internalType: 'contract IRateProvider[]', name: 'providers', type: 'address[]' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
