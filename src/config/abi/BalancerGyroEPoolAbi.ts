...
export const BalancerGyroEPoolAbi = [
  {
    inputs: [
      {
        components: [
          ...
          { internalType: 'address', name: 'rateProvider0', type: 'address' },
          { internalType: 'address', name: 'rateProvider1', type: 'address' },
          { internalType: 'address', name: 'capManager', type: 'address' },
          {
            components: [
              { internalType: 'bool', name: 'capEnabled', type: 'bool' },
              { internalType: 'uint120', name: 'perAddressCap', type: 'uint120' },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'capManager', type: 'address' }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'bool', name: 'derivedParamsValidated', type: 'bool' },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'bool', name: 'paramsValidated', type: 'bool' }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'invariantAfterJoin', type: 'uint256' },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'oldInvariant', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'newInvariant', type: 'uint256' },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'oldPauseManager', type: 'address' },
      { indexed: false, internalType: 'address', name: 'newPauseManager', type: 'address' },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256[]', name: 'balances', type: 'uint256[]' },
      {
        components: [
          { internalType: 'int256', name: 'x', type: 'int256' },
          { internalType: 'int256', name: 'y', type: 'int256' },
  ...
  {
    inputs: [{ internalType: 'address', name: '_pauseManager', type: 'address' }],
  ...
  },
  {
    inputs: [],
    name: 'gyroConfig',
    outputs: [{ internalType: 'contract IGyroConfig', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
