...
export const BeefyCommonBridgeAbi = [
  {
    inputs: [
      { internalType: 'contract IERC20', name: '_bifi', type: 'address' },
      { internalType: 'contract IXERC20', name: '_xbifi', type: 'address' },
      { internalType: 'contract IXERC20Lockbox', name: '_lockbox', type: 'address' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'address', name: 'tokenReceiver', type: 'address' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'address', name: 'bridgeUser', type: 'address' },
      { indexed: true, internalType: 'address', name: 'tokenReceiver', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'amount', type: 'uint256' },
    ],
    name: 'BridgedOut',
  ...
  },
  {
    inputs: [],
    name: 'lockbox',
    outputs: [{ internalType: 'contract IXERC20Lockbox', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
