...
import { InvalidAddress, InvalidDomain, NoResults } from './components/NoResults/NoResults.tsx';
...
import { DashboardLayout, NoticeLayout } from './Layouts.tsx';
...
const DashboardFromDomain = memo(function DashboardFromDomain({
  ...
  if (isRejectedStatus(status)) {
    return <NoticeLayout content={<InvalidDomain />} />;
  }
...
const DashboardAddressPage = memo(() => {
  return (
    <>
      <DashboardMeta />
      <DashboardFromUrl />
