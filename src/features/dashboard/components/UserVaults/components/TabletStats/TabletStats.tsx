...
import { selectVaultYieldStats, selectVaultTotalApy } from '../../../../../data/selectors/apy';
...
export const TabletStats = memo<TableStatsInterface>(function TabletStats({ vaultId, address }) {
  ...
  const { dailyUsd } = useAppSelector(state => selectVaultYieldStats(state, vaultId, address));
