    ...
    <Card>
      ...
      <CardContent>
                  ...
                  <div className={classes.infoContainer}>
                    ...
                    <div>
                      ...
                      <Typography className={classes.riskCategory}>
                        {categoryText(RISKS[risk].category)}
                      </Typography>
                    </div>
                  </div>
                  <div className={classes.moreInfoContainer}>
                    <Typography className={classes.moreInfoLabel}>What does this mean</Typography>
                    <Popover title={RISKS[risk].title} content={RISKS[risk].explanation} />
                  </div>
                </div>
              )}
            </Box>
        ...
        <div className={classes.notes}>
          ...
          <Typography>
            Your funds are secure on Beefy.Finance. The development team put a lot of time and
            effort into checking the code of the vaults they add to the platform. They also have a
            panic button to pause and protect your assets at short notice if there is any suspicious
            activity.
          </Typography>
        </div>
      </CardContent>
